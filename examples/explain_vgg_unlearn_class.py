...
dataset = ImageNetDataset(root_dir='torch_imagenet/imagenet-mini/train/n01734418', transform=transform)
...
def compute_and_plot_explanation_multiAnalysis(rule, ax_, patterns=None, plt_fn=heatmap_grid): 
    ...
    # 保存到文件
    # with open('neuron/imagenet/{}.pkl'.format(unlearn_class), 'wb') as f:
