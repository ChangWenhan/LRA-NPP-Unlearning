...
full_dataset = torchvision.datasets.CIFAR100(root='/home/cwh/Workspace/TorchLRP-master/data', train=False, download=True, transform=transform)
...
vgg_unlearn = torch.load('examples/models/resnet50_cifar100_unlearned.pth').to(device)
vgg_origin = torch.load('examples/models/resnet50_cifar100_5.pth').to(device)
vgg_unlearn.eval()
vgg_origin.eval()
...
patterns_path = (base_path / 'examples' / 'patterns' / 'CIFAR100_pattern_pos.pkl').as_posix()
...
fig.tight_layout()
fig.savefig(base_path / 'examples' / 'plots' / "Cifar100_explanations_origin.png", dpi=280)
figun.tight_layout()
figun.savefig(base_path / 'examples' / 'plots' / "Cifar100_explanations_unlearn.png", dpi=280)